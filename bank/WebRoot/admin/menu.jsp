	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>利率信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	              <li><a href='<%=path %>/lilvMana.action' target='main'>利率信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>储户信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	              <li><a href='<%=path %>/userMana.action' target='main'>储户信息管理</a> </li>
	              <li><a href='<%=path %>/admin/user/userAdd.jsp' target='main'>储户信息开户</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->

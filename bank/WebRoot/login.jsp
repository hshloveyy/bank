...
<body>
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/img/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 33pt;">银行业务系统</div></td>
	 </tr>
	 <tr>
		<td width="559">
				...
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
			        ...
			        <tr>
						...
						<td width="356" valign="bottom">
						    ...
						    <font style="font-size: 11px;color: red">储户请输入卡号</font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td height="31" colspan="2" valign="top" class="STYLE15">
						     密&nbsp;&nbsp;&nbsp;&nbsp;码：
							<input name="userPw" type="password" style="width: 150px;">
						</td>
					</tr>
					<tr style="display: block">
					    <td height="31" colspan="2" valign="top" class="STYLE15">
					         身&nbsp;&nbsp;&nbsp;&nbsp;份：
					         <select class="INPUT_text" name="userType" style="width: 150px;">
								<option value="0">管理员</option>
								<option value="1">储&nbsp;&nbsp;&nbsp;户</option>
							 </select>
                        </td>
				    </tr>
					<tr>
